...
import maingame.*;
import utils.*;
public final class LevelAdder{


    // Code en partie inspiré par https://docs.oracle.com/javafx/2/ui_controls/file-chooser.htm
    ...
    public static void start(final Stage stage) {
        ...
        if (list != null) { // si la liste de fichiers choisi n'est pas vide
            for (File file : list) {
                String path = System.getProperty("user.dir") + "/src/main/resources/customlevels/";  // on selectionne le fichier de destination
